...
public class OrderView {
     ...
     * @return 新订单视图
     */
    public OrderView withStatus(OrderStatus nextStatus) { return new OrderView(id, userId, items, totalAmount, nextStatus, createdAt, nextStatus == OrderStatus.PAID ? Instant.now() : paidAt); }
