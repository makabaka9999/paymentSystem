...
(101, 2, 'Mechanical Keyboard Pro', 'Office Peripherals', 'Hot-swappable keyboard for high-frequency typing', 'APPROVED', 1),
(102, 2, 'Wireless Noise-Cancelling Headphones', 'Digital Audio', 'Comfortable audio gear for commuting and office work', 'APPROVED', 1),
(103, 2, 'Ergonomic Chair', 'Office Furniture', 'Supportive chair for long work sessions', 'APPROVED', 1);
INSERT IGNORE INTO product_sku(id, product_id, sku_name, price) VALUES
(10001, 101, 'Default', 399.00),
(10002, 102, 'Default', 699.00),
(10003, 103, 'Default', 1299.00);
